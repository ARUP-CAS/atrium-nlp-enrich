...
| **v0.13.0** | Alignemnt of BBOXes in TEITOK XMLs implemented to use metadata of the page image sizes instead of real page image files. Post factum fix added.                                                                                                                                                       | Pre-release |
