...
api_util/bbox_scale.py is byte-identical to the copy in atrium-llm-enrich (which
ships this same suite). Previously nlp only reached a subset of these helpers
indirectly via tests/test_rescale.py; this adds direct coverage of the unit /
scaling / surface-extent / rewrite paths and keeps the twin repos at test parity.
"""
