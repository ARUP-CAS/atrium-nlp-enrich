...
LICENSE_RANK: Dict[str, int] = {
    ...
    "AGPL-3.0": 4,  # network copyleft – commercial-OK but viral over a network
    ...
    # Vendor model licenses (custom EULAs). Ranked at the non-commercial tier
    # because their usage terms forbid the commercial case in practice.
    # Review note: these are NOT OSI/CC licenses; the rank is a conservative
    # mechanical approximation pending licensing-owner review.
    "glm-4": 5,  # Zhipu AI GLM-4 model license (GLM-4v-9b weights)
}
